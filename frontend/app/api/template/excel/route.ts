...
export async function GET() {
  try {
    ...
    pvSheet.addRow([1, 'Beispiel PV-Standort', 'Musterstraße 1, 12345 Musterstadt', 'pv', 'Ja', 500, 50, 'Produktion & Fertigung', 250, 1100, 180, 32, 0.35]); // umsatz: 500 = 500 × 10k = 5M
    ...
    storageSheet.addRow([1, 'Beispiel Speicher-Standort', 'Musterstraße 2, 12345 Musterstadt', 'storage', 'Nein', 300, 30, 'Energie & Versorgung', 100, 50000, 80, 150, 0.35]); // umsatz: 300 = 300 × 10k = 3M
    ...
    chargingSheet.addRow([1, 'Beispiel Ladeinfrastruktur-Standort', 'Musterstraße 3, 12345 Musterstadt', 'charging', 'Ja', 200, 20, 'Einzelhandel & Handel', 50, 1500, 120, 200, 12]); // umsatz: 200 = 200 × 10k = 2M
